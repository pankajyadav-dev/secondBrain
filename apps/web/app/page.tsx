...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-900 text-foreground relative overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <main className="relative z-10 text-center px-4 max-w-4xl mx-auto w-full">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 sm:mb-6 bg-clip-text text-transparent bg-linear-to-b from-white to-white/50">
          Your Second Brain
        </h1>
